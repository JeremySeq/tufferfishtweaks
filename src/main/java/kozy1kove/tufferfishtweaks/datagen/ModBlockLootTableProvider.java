...
public class ModBlockLootTableProvider extends FabricBlockLootSubProvider {
    ...
    public void generate() {
        ...
        //dropSelf(ModBlocks.CHORIUM_ORE); this is for normal blocks that dropself

        add(ModBlocks.CHORIUM_ORE, createOreDrop(ModBlocks.CHORIUM_ORE, Moditems.RAW_CHORIUM));
